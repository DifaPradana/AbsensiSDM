                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                @if($absensi->photo_masuk)
                                <img src="{{ asset('storage/' . $absensi->photo_masuk) }}?v={{ time() }}" alt="Foto Masuk" class="img-fluid rounded">
                                @else
                ...
                <div class="modal fade" id="modalPulang{{ $absensi->absensi_id }}" tabindex="-1" aria-hidden="true" wire:ignore.self>
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                                @if($absensi->photo_pulang)
                                <img src="{{ asset('storage/' . $absensi->photo_pulang) }}?v={{ time() }}" alt="Foto Pulang" class="img-fluid rounded">
                                @else
